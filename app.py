# -*- coding: utf-8 -*-
"""Phase5_final_corrected.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kN6azXX-7kKC-cFA6-2c7UiLJlR1rZHJ
...
def get_search_relevance(test_set):
  ...
  data1['last_word_in_title'] = data1.progress_apply(lambda x: x['corrected_search'].split()[-1] in x['title'].split(), axis=1)
  data1['last_word_in_desc'] = data1.progress_apply(lambda x: x['corrected_search'].split()[-1] in x['description'].split(), axis=1)
  ...
  data1['numbers_in_attr'] = data1.progress_apply(lambda x: count_number_in_search_attr(x['corrected_search'], x['attributes']), axis=1)
  data1['numbers_in_title'] = data1.progress_apply(lambda x: count_number_in_search_attr(x['corrected_search'], x['title']), axis=1)
  data1['numbers_in_desc'] = data1.progress_apply(lambda x: count_number_in_search_attr(x['corrected_search'], x['description']), axis=1)

  data1['title_common_word_count'] = data1.progress_apply(lambda x: common_word_count_ngrams(x['corrected_search'], x['title'], edit_distance_thresshold=1), axis=1)
  data1['desc_common_word_count'] = data1.progress_apply(lambda x: common_word_count_ngrams(x['corrected_search'], x['description'], edit_distance_thresshold=1), axis=1)
  data1['attr_common_words_count'] = data1.progress_apply(lambda x: common_word_count_ngrams(x['corrected_search'], x['attributes'], edit_distance_thresshold=1), axis=1)
  
  data1['title_common_word_count_bigram'] = data1.progress_apply(lambda x: common_word_count_ngrams(x['corrected_search'], x['title'], ngram=2, edit_distance_thresshold=4), axis=1)
  data1['desc_common_word_count_bigram'] = data1.progress_apply(lambda x: common_word_count_ngrams(x['corrected_search'], x['description'], ngram=2,edit_distance_thresshold=4), axis=1)
  data1['attr_common_word_count_bigram'] = data1.progress_apply(lambda x: common_word_count_ngrams(x['corrected_search'], x['attributes'], ngram=2,edit_distance_thresshold=4), axis=1)
  ...
  data2['cosine_search_term_Title'] = data2.progress_apply(lambda row: cosine_similarity_sent(row['corrected_search'], row['title']), axis=1) 
  data2['cosine_search_term_desc'] = data2.progress_apply(lambda row: cosine_similarity_sent(row['corrected_search'], row['description']), axis=1)

  data2['search_term_contains_brand'] = data2.progress_apply(lambda x: includes_brand(x['corrected_search'], x['brand']), axis=1)

  data2['min_jcc_brand_with_search_term'] = data2.progress_apply(lambda x: minimum_jaccard_coefficient(x['corrected_search'], x['brand']), axis=1)
  data2['min_edit_brand_with_search_term'] = data2.progress_apply(lambda x: minimum_edit_distance(x['corrected_search'], x['brand']), axis=1)

  data2['min_jcc_title_with_search_term'] = data2.progress_apply(lambda x: minimum_jaccard_coefficient(x['corrected_search'], x['title']), axis=1)
  data2['min_edit_title_with_search_term'] = data2.progress_apply(lambda x: minimum_edit_distance(x['corrected_search'], x['title']), axis=1)

  data2['mean_jcc_product_title_with_search_term'] = data2.progress_apply(lambda x: get_mean_jcc_searchterm_and_title(x['corrected_search'], x['title']), axis=1)
  data2['mean_jcc_product_desc_with_search_term'] = data2.progress_apply(lambda x: get_mean_jcc_searchterm_and_desc(x['corrected_search'], x['description']), axis=1)
  
  data2['mean_jcc_attr_with_search_term'] = data2.progress_apply(lambda x: get_mean_jcc_searchterm_and_attr(x['corrected_search'], x['attributes']), axis=1)
  

  data2['sum_jaccard_product_title_with_search_term'] = data2.progress_apply(lambda x: sum_jcc(x['corrected_search'], x['title']), axis=1)
  data2['sum_edit_product_title_with_search_term'] = data2.progress_apply(lambda x: sum_edit_distance(x['corrected_search'], x['title']), axis=1)
  data2['sum_jcc_prod_desc_with_search_term'] = data2.progress_apply(lambda x: sum_jcc(x['corrected_search'], x['description']), axis=1)

  
  
  data2=data2[['cosine_search_term_Title','cosine_search_term_desc','search_term_contains_brand','min_jcc_brand_with_search_term',
               'min_edit_brand_with_search_term','min_jcc_title_with_search_term','min_edit_title_with_search_term','mean_jcc_product_title_with_search_term',
               'sum_jaccard_product_title_with_search_term','sum_edit_product_title_with_search_term','sum_jcc_prod_desc_with_search_term',
  ...
  cosine_similarity_tfidf_search_title_des = [cosine_similarity([x], [y]) for x,y in zip(truncated_search, truncated_title_desc)]
  ...
  cosine_similarity_tfidf_search_des = [cosine_similarity([x], [y]) for x,y in zip(truncated_search, truncated_pd_train)]
  ...
  data4['bm25_ST'] = data4.apply(lambda row: okapi_bm25_score(row['corrected_search'], row['title'], params_title_bm25 ), axis=1)
  data4['bm25_SD'] = data4.apply(lambda row: okapi_bm25_score(row['corrected_search'], row['description'], params_desc_bm25 ), axis=1)
  data4['bm25_SB'] = data4.apply(lambda row: okapi_bm25_score(row['corrected_search'], row['brand'], params_brand_bm25 ), axis=1)
...
def predict():
  ...
  print(type(results))
  print(results)
  jsonfiles = json.loads(results.to_json(orient='records'))
  print(jsonfiles)
  params = {'results': jsonfiles, 'search': search}
